...
- [ ] Написание шаблонов (docker-compose.yml.tpl, config.json.tpl, .env.example)
- [ ] Скрипт install.sh с интерактивным вводом параметров
- [ ] Реализация валидации вводимых данных
- [ ] Создание рабочих каталогов в /opt/vless/
- [ ] Копирование файлов из репозитория в /opt/vless/
- [ ] Генерация .env файла с введенными параметрами
- [ ] Генерация X25519 ключей
