...
- **Маршрутизация:** Автоматическая настройка IP forwarding, iptables NAT MASQUERADE, UFW для Docker bridge
- **Скрипты:** Bash
...
│   │   ├── network.sh          # Сетевые настройки (IP forwarding, NAT, определение свободной подсети)
